...
var adminName = 'admin-' + date.getMonth() + '-' + date.getDate() + '-' + date.getFullYear() + '.js';
...
gulp.task('animations', function () {
  gulp.src("src/sass/inline_styles/search_animations.css")
...
gulp.task('minifyScripts', function () {
  gulp.src("src/scripts/exclude/search_admin.js")
    .pipe(sourcemaps.init())
    .pipe(babel())
...
gulp.task('listen', function () {
  ...
  gulp.watch("src/sass/inline_styles/search_animations.css").on('change', function (file) {
    gulp.start(['animations', 'pages', 'layouts']);
  });
  // includes
